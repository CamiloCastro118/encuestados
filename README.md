...
Sistema completo para gestion de encuestas con **Angular 19*
...
- `POST /:id/respuesta` - Enviar respuesta```npm run build               

##  Componentes Frontend

### Paginas Principalesnpm run start:backendnpm run git:check # Verificar en qu rama esta
